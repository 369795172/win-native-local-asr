...
- QA+ local evidence: `dotnet test src/WinLocalASR.sln` → passed 19, skipped 2, failed 0. Windows-only chain + enumeration results recorded from CI (see run link below).
